...
@Component({
  selector: 'app-report1-page',
  templateUrl: './report1-page.component.html',
  styleUrls: ['./report1-page.component.scss']
})
export class Report1PageComponent implements OnInit {
  allData: any = []
  ...
  filterTable() {
    ...
    this.isLoading = true
    this.request.getFilterReport1Request(allFilterFormData.date_from, allFilterFormData.date_to).subscribe(response => {
  ...
  jsonReport1() {
    const allFilterFormData = {...this.allFilterForm.value}
    this.request.getFilterReport1Request(allFilterFormData.date_from, allFilterFormData.date_to).subscribe( (response: any) => {
